...
import com.exa.expensetracker.ui.home.HomeFragment;
...
public class WeekSpentAdapter extends RecyclerView.Adapter<WeekSpentAdapter.MyViewHolder>{
    ...
    public WeekSpentAdapter(Context mContext, List<HomeDataModel> myHomeDataModelList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new WeekSpentAdapter.MyViewHolder(view);
    }
